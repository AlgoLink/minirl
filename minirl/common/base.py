...
from minirl.preprocessing.base import Base
...
class Policy(Base, abc.ABC):
    ...
    def __init__(self, reward_obj=None, burn_in=0):
        self.reward_obj = reward_obj or stats.Mean()
        self.burn_in = burn_in
        self._rewards = collections.defaultdict(self.reward_obj.clone)
        self._n = 0

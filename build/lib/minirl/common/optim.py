...
class MyAdam:
    def __init__(self, weights, learning_rate=0.001, beta1=0.9, beta2=0.999):
        """
    ...
    def update(self, grads):
        ...
        for k in grads:
            ...
            m_k_hat = self.M[k] / (1.0 - self.beta1**self.t)  # bias correction
            v_k_hat = self.V[k] / (1.0 - self.beta2**self.t)  # bias correction
            self.weights[k] -= (
                self.learning_rate * m_k_hat / (np.sqrt(v_k_hat) + self.eps)
            )
